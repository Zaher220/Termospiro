...
// экспорта из библиотек DLL. Все файлы данной DLL скомпилированы с использованием символа RTUSBAPI_EXPORTS,
...
// функции RTUSBAPI_API как импортированные из DLL, тогда как данная DLL видит символы,
// определяемые данным макросом, как экспортированные.
#include "windows.h"
#include <tchar.h>
#ifdef RTUSBAPI_EXPORTS
#define RTUSBAPI_API __declspec(dllexport)
#else
#define RTUSBAPI_API __declspec(dllimport)
#endif

// Этот класс экспортирован из Rtusbapi.dll
/*class RTUSBAPI_API CRtusbapi {
public:
	CRtusbapi(void);
	// TODO: Добавьте здесь свои методы.
};*/

extern RTUSBAPI_API int nRtusbapi;

RTUSBAPI_API int fnRtusbapi(void);
